  ...
  <div class="flex flex-col h-screen">
    ...
    <div class="sticky bottom-0 w-full p-6 pb-8 bg-gray-100">
      ...
      <div class="flex items-center">
        <Reload />
        <input
          class="ml-2 mr-4 px-4 py-2 text-gray-700 bg-white border rounded-md focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 flex-grow"
